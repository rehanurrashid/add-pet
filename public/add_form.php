                    ...
                    <form method="POST" id="save_ap_post" class="ap-form js-form" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col col-6">
                            ...
                            <p id="pet_breed_error" class="mb-2 ml-1" style="display:none; color:#B81111;">Pet Breed is required.</p>
                          </div>
                          <div class="col col-6">
                            <div class="form-group">
                            ...
                            <p id="pet_gender_error" class="mb-2 ml-1" style="display:none; color:#B81111;">Pet gender is required.</p>
                          </div>
                        </div>
                        <div class="form-group">
                          <input type="text" class="form-input" name="post_title" id="post_title"  placeholder="Title" required />
                          <small class="text-muted">Mention the key features of your pet (e.g. brand, model, age, type)</small>
                          <p id="title_required" class="mt-1 ml-1" style="display:none; color:#B81111;">Title is required!</p>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <div class="form-check mt-5 mb-2">
                              ...
                              <label class="form-check-label" for="agree_term">I agree all statements in  <a href="#" class="text-primary">Terms of service</a></label>
